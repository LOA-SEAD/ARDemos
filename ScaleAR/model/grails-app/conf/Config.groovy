...
grails.project.groupId = appName // change this to alter the default package statement and Maven publishing destination
...
fileName: "${System.properties['catalina.home']}/logs/${grails.util.Metadata.current.'app.statement'}.log",
