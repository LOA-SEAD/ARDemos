...
[CustomEditor(typeof(Imported_ActivateInformation))]
[CanEditMultipleObjects]
public class Imported_ActivateInformationI : Editor{
    ...
    private Imported_ActivateInformation activateInformation;

    private void OnEnable()
    {
        activateInformation = (Imported_ActivateInformation)target;//NOTA:foi necessario para acessar ao MyCanvas e obter o numero dos seus filhos, o que permitirá inicializar o vetor dos pontos (points) no valor obtido
    ...
    public override void OnInspectorGUI()
    {
        ...
        //Imported_ActivateInformation.TypeOfInformation type = (Imported_ActivateInformation.TypeOfInformation)typeOfInformation.enumValueIndex;
        //if (type == Imported_ActivateInformation.TypeOfInformation.texts3D)
        //{
        ...
        //}
        /*
        else if(type == Imported_ActivateInformation.TypeOfInformation.sprites)
        {
        ...
        else if(type== Imported_ActivateInformation.TypeOfInformation.canvasOfImages)
        {
    ...
    static void DrawGizmoForMyScript(Imported_ActivateInformation scr, GizmoType gizmoType)
    {
