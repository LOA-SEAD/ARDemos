<%@ page import="br.ufscar.sead.loa.ardemo.remar.Question" %>
<!DOCTYPE html>
<html>
<head>
...
<div class="cluster-header">
    <p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
        <i class="small material-icons left">grid_on</i>Demo AR - Banco de Questões
    </p>
</div>
...
<script type="text/javascript" src="/ardemo/js/questions.js"></script>
</body>
</html>
